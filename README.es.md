...
Proyecto universitario — curso de **Estructuras de Datos**, Universidad Fidélitas, Costa Rica.

Sistema de gestión de terminales de buses desarrollado en Java puro: todas las estructuras de datos (listas enlazadas, colas de prioridad, grafos ponderados dirigidos) implementadas desde cero, sin el Java Collections framework.
...
| Estructuras de datos | Listas enlazadas, cola de prioridad, grafo ponderado dirigido |

---

## Flujo del sistema

1. **Inicio** — verifica si existe `config.json`
2. **Configuración inicial** — si no existe, solicita nombre de terminal, cantidad de buses y credenciales de dos usuarios
3. **Login** — autenticación con credenciales configuradas
...
- Cantidad de buses (mínimo 3 — 1 preferencial, 1 directo, el resto normales)
...
- [Módulos](./docs/es/modules.md) — objetivos, funcionalidades y requerimientos por módulo
- [Arquitectura](./docs/es/architecture.md) — estructura de clases, árbol de archivos y referencia de métodos
- [Changelog](./docs/es/changelog.md) — correcciones y mejoras por entrega
